...
export default function PageShell({ title, description, variant = "default", className = "", children }) {
  ...
  return (
    <div className={`mx-auto flex w-full flex-1 flex-col px-4 py-4 sm:px-6 sm:py-5 ${max} ${className}`.trim()}>
      {title || description ? (
        <header className="border-default-200/80 mb-4 border-b pb-4">
