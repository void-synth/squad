        ...
        <div className="flex min-w-0 items-center gap-3 sm:gap-4">
          <div className="flex items-center gap-2.5">
            <span
              ...
              aria-hidden
            />
            <NavLink to="/" className="group flex min-w-0 items-center gap-2 no-underline">
          ...
          <nav className="bg-default-100/80 flex items-center gap-0.5 rounded-xl p-0.5 sm:gap-1" aria-label="Primary">
            <NavLink to="/" end aria-label="Dashboard" className={({ isActive }) => navClass(isActive)}>
              <Home2 size={17} variant="Linear" className="shrink-0" />
              <span className="hidden sm:inline">Dashboard</span>
            </NavLink>
            <NavLink to="/alerts" aria-label="Alerts inbox" className={({ isActive }) => navClass(isActive)}>
