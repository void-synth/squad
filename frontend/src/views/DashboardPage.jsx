...
export default function DashboardPage() {
  ...
  if (transactionsLoading && !bootstrapError) {
    return (
      <div className="flex w-full flex-col items-center justify-center gap-4 px-6 py-16 text-default-500">
  ...
  return (
    <div className="flex w-full flex-col px-3 pt-2 pb-3 sm:px-5 sm:pt-3 sm:pb-4 lg:px-6 lg:pt-3 lg:pb-5">
      ...
      <div className="grid w-full grid-cols-1 gap-4 lg:gap-5 xl:grid-cols-[minmax(0,1fr)_400px]">
        <section className="min-w-0" aria-label="Transactions">
          <TransactionFeed />
        </section>
        <section className="min-w-0" aria-label="Case actions">
          <AlertPanel />
        </section>
      </div>
    </div>
